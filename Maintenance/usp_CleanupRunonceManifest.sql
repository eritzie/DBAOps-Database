/*
===================================================================================================
DBAOps Database - Maintenance: Cleanup RunOnce Manifest
...
CREATE OR ALTER PROCEDURE [deploy].[usp_CleanupRunOnceManifest]
...
PRINT '***** Procedure [deploy].[usp_CleanupRunOnceManifest] created.';
GO
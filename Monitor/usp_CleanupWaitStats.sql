...
Usage:
    ...
    EXEC [monitor].[usp_CleanupWaitStats] @RetentionDays = 14;
...
CREATE OR ALTER PROCEDURE [monitor].[usp_CleanupWaitStats]
...
PRINT '***** Procedure [monitor].[usp_CleanupWaitStats] created.';
GO